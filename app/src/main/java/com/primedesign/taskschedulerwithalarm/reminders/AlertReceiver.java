package com.primedesign.taskschedulerwithalarm.reminders;
...
import com.primedesign.taskschedulerwithalarm.AddEditTaskActivity;
import com.primedesign.taskschedulerwithalarm.R;
import com.primedesign.taskschedulerwithalarm.TaskSchedulerApp;
import com.primedesign.taskschedulerwithalarm.utils.ActionReceiver;

import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTCATEGORY;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTDESCRIPTION;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTID;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTMILLI;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTPRIORITY;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTSTATUS;
import static com.primedesign.taskschedulerwithalarm.AddEditTaskActivity.EXTRA_ALERTTITLE;
...
//                dialog, 0);
        ...
        NotificationCompat.Builder nb = new NotificationCompat.Builder(context, TaskSchedulerApp.CHANNEL_1_ID)
                ...
                .addAction(R.drawable.ic_play_arrow_black_, "set ongoing", firstActionPendingIntent)
                .addAction(R.drawable.ic_add_alarm_black, "snooze by 10 minutes", secondActionPendingIntent);
                //
